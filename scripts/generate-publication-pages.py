...
<main id="vr-main" tabindex="-1"><div class="vr-doc-shell"><section class="vr-page-hero"><span class="vr-kicker">Research record / {esc(r['resourceType'])}</span><h1>{esc(r['title'])}{(" — " + esc(r['version'])) if r['doi'] in {"10.5281/zenodo.22258644","10.5281/zenodo.22262388","10.5281/zenodo.22287006"} else ""}</h1><p>{esc(r['scope'])}</p><div class="vr-page-meta"><span>{esc(r['version'])}</span><span>{r['publicationDate']}</span><span>Zenodo</span></div></section>
