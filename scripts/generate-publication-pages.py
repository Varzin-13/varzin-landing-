...
def schema_for(r, rid):
    ...
    obj = {
        ...
        'description':r['scope'], 'keywords':r.get('keywords', []), 'isPartOf':{'@type':'WebSite','name':'VARZIN','url':'https://varzin.org/'}
    }
...
<title>{esc(r['title'])} | VARZIN Research Record</title><meta name="description" content="{esc(r['scope'])}">{citation_meta}
