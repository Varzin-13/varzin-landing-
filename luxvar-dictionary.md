> **Research Note (2026-06-14):**
> VPE-001B (AI clustering benchmark) found that Claude, GPT-4, and Gemini
> independently grouped LUXVAR words by **morpheme families** (ELUZ, SHA, NAR)
> rather than by the designed semantic axes (LIGHT/REFLECTION/SILENCE/GATE/MOTION).
> This is consistent with the computational layer finding that LUXVAR's recoverable
> structure is morphemic, not axial. VPE-001A (human raters) will test whether
> humans also cluster by morpheme or by semantic axis.
>
> Key morpheme families identified across all 3 AIs:
> - **ELUZ family:** ELUZ-MAHAR, MATIR-ELUZ, SAR-ELUZ, SAVAR-ELUZ, TARHAN-ELUZ, ELURIM
> - **SHA family:** SHAUREN, SHARUM-DOZ, RAHMOT-SHA, NARAH-SHA, SHUKAR-MAH, SHALOM-HATTAH
> - **NAR family:** NARAH, NARAH-SHA, ZUN-NAR, NEMRUH, NAZRUK

---

🗝️ LUXVAR DICTIONARY – Layer 1 (Initial Field Words)
